...
Вскоре стало ясно, что старый сервер все таки не справляется с нагрузкой. А, поскольку основное оборудование было занято другими проектами, нам приходилось выжимать максимум из доступного. Нам удавалось поддерживать относительно стабильную работу, но долго так продолжаться не могло. Таким образом мы снова вернулись к поиску другого размещения для сервера. В течение второй половины 2019 года Last Day переезжал на разные компьютеры в разные датацентры. Многие из таких переездов сопровождались сменой ip адреса, что негативно сказывалось на онлайне сервера. Также каждый переезд нёс в себе риски совершения вайпа, а делать его не хотелось. Несколько раз игровой мир приходилось спасать после неудачного переноса на другой сервер. Но переезды каждый раз делать приходилось, так как с размещением нам сильно не везло. Мы или попадали на жесткие лимиты использования ресурсов оборудования, что делало новое размещение хуже предыдущего или сталкивались с отсутствием нормальной технической поддержки. Эта проблема была полностью решена только к декабрю 2019 года, когда **Outdead** и **Tiarv**, поделив расходы пополам, арендовали выделенный сервер в Selectel (один из крупнейших датацентров России, изначально создавался для размещения там первых серверов ВКонтакте). 
