...
[1 сезон] (2014-09-14 - 2015-10-24) (405 дней) ([скриншоты](https://vk.com/album-98542138_276575436))  
...
Сервер Last Day существует и развивается с 2014 года и является одним из старейших серверов, который дожил до нашего времени. Как и многие другие сервера, Last Day создавался для себя после неудачного опыта игры на других серверах. Долгосрочных планов его развития не было, но сервер не был закрытым и к нему время от времени присоединялись новые игроки. Количество игроков продолжало расти и было принято решение оставить сервер как долгоживущий проект. 14 сентября 2014 года Red (@Red#2901) разместил первую публичную информацию о сервере и эту дату можно считать официальной датой открытия сервера.

## Первый сезон
_14 сентября 2014 - 24 октября 2015 (405 дней)_  
...
Примерно в это же время мы принимаем решение создать для сервера отдельный Discord https://discord.gg/svRtD7t, а общую группу оставить для технической поддержки по другим проектам WARGM. Здесь нужно что-то написать про завершение сезона и массовый уход многих игроков на другой сервер, включая модератора **Calipso**, но мы не помним как это произошло. К тому времени у **outdead** совершенно не было времени и последний месяц сезона проходит без его участия. К 1 сентября **Red** решает закрыть сезон и начать новый.
...
Вскоре стало ясно, что старый сервер плохо справляется с возрастающей нагрузкой при повышении онлайна. На предыдущее оборудование мы не могли вернуться, так как оно все еще было занято другими проектами WARGM. Поэтому нам приходилось выжимать максимум из нашего старого сервера. Нам удавалось поддерживать относительно стабильную работу, но долго так продолжаться не могло и мы снова вернулись к поиску другого размещения для сервера. За следующие пол года Last Day часто перемещался на разные сервера у разных поставщиков услуг. Некоторые переезды происходили незаметно, но многие сопровождались сменой ip адреса, что негативно сказывалось на онлайне сервера. Более того, каждый переезд нёс в себе риски поломки игрового мира и вероятности совершения вайпа - а вайпы делать не хотелось. Несколько раз после неудачного переноса игровой мир все таки отказывался запускаться и его приходилось чинить. Каждый раз, совершая перенос сервера, мы надеялись, что наконец-то нашли хорошего хостинг-провайдера. Но через какое-то время выяснялось, что это не так. Часто мы попадали на оверселлинг и/или к нам применялись жесткие лимиты использования ресурсов. Техническая поддержка часто оказывалась бесполезной, в то время как стоимость услуг только возрастала. 

Часть расходов нам помогал окупать все еще работающий игровой магазин, но и это продлилось недолго - в конце мая 2019 года к нам обратились менеджеры The Indie Stone с требованием его закрыть. После непродолжительного общения с менеджерами игры, первого июня мы выключили магазин и остались без единственного способа сократить расходы на содержание сервера. После конфликта с менеджерами игры **Red** постепенно стал отдаляться от Last Day, все более концентрируясь на развитии WARGM. В августе 2019 года он и вовсе полностью передал владение сервером в руки **outdead**. С этих пор WARGM.RU и Last Day стали независимыми дружественными проектами. В сентябре мы совершили еще один переезд на достаточно мощный и относительно стабильный сервер, на котором Last Day проработал следующие 3 месяца. Тогда же был настроен мониторинг, что стало позволять нам находить проблемные места производительности и более тонко настраивать программное обеспечение сервера. Проблему размещения сервера удалось полностью решить только к декабрю 2019 года, когда **outdead** арендовал выделенный сервер в Selectel, а **Tiarv** оказал значительную материальную поддержку, разделив половину стоимости годовой аренды. В течение нескольких недель мы производили настройку и тестирование нового оборудования и 26 декабря 2019 года совершили последний перенос сервера.

За первые пол года сезона мы столкнулись с множеством трудностей и технических проблем. Но мы старались концентрироваться не только на них, но и заниматься улучшением игрового процесса. Во многом это было возможно благодаря активным игрокам, которые хотели сделать для сервера что-то полезное. В начале июня на перекрестке Muldraugh и West Point игроками **Four-Eyes** и **Mixa100100100** был снова возведен бар. Ему присваивается статус PVE локации и включается защита ботом от разрушений. Позднее для локации был создан NPC с именем **Greedy Bastard**, которым велась торговля и ценообразование на сервере. 

![20190828_002207_Ded.jpg](images/screenshots/20190828_002207_Ded.jpg)  

Вскоре **Mixa100100100** кооперируется со стримером **neltu** (@Failefalcon#2007) и игроком **Ben McCormick**. Под управлением **neltu** они строят полу-РП локацию Hospital в не названном разработчиками (Мертвом) городе по центру карты. В госпитале, как и ожидается, предоставляется медицинская помощь, включая лечение сломанного в игре понижения веса и возможность излечения от никотиновой зависимости. Это было возможно благодаря разработанному специально для сервера моду [Permanent Effects Drinks](https://steamcommunity.com/sharedfiles/filedetails/?id=1866992334), который добавляет в игру специальные напитки, влияющие на персонажа. Эти напитки нельзя было найти на карте, они могли быть получены только через взаимодействие с NPC **Greedy Bastard** в его баре "[Мёртвая Гарпия](https://wiki.last-day.ru/locations/dead_harpy)".   

![20191024_191328_Hospital_screenshot.png](images/screenshots/20191024_191328_Hospital_screenshot.png)  
![20191028_003506_Hospital_plan.png](images/screenshots/20191028_003506_Hospital_plan.png)
